...
function Tabs({
  ...
  const [currentKey, setCurrentKey] = (0, import_react3.useState)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex flex-col gap-md", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex gap-sm min-w-max px-xs", children: itemsFilter.map((item) => {
          if (!item) return null;
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
            "button",
            {
              ...
              children: [
                item.icon && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "w-[16px] h-[16px] flex items-center", children: item.icon }),
                /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "text-nowrap", children: item.label }),
                active && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "absolute left-0 right-0 -bottom-[1px] h-[2px] bg-primary" })
              ]
            },
            item.key
          );
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "p-md bg-ink-0 rounded-md border border-ink-300", children: activeTab?.content })
  ] });
}
...
function AppTable({
  ...
  const [sorter, setSorter] = (0, import_react4.useState)();
  const getRowKey = (record) => typeof rowKey === "function" ? rowKey(record) : record[rowKey];
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "w-full bg-ink-0 relative flex flex-col gap-md", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("table", { className: "min-w-full border-collapse", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("tr", { children: [
        select && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("th", { className: (0, import_clsx12.default)(
          "border-y px-md py-md text-left",
          "font-medium text-primary-100 hover:text-ink bg-primary"
        ), children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "flex items-center gap-xs", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          "input",
          {
            type: "checkbox",
        ...
        columns.map((col, index) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          "th",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
              "div",
              {
                ...
                children: [
                  col.sorter && (col.key === sorter?.field ? sorter.order === "asc" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_hi2.HiMiniChevronUp, {}) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_hi2.HiMiniChevronDown, {}) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_hi2.HiMiniChevronUpDown, {})),
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "whitespace-nowrap", children: col.title })
                ]
              }
            )
          },
      ...
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("tbody", { className: "", children: data.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("td", { colSpan: columns.length, className: "p-md text-center h-36", children: !loading && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_hi.HiOutlineDocumentSearch, { className: "w-6 h-6 text-ink/50 mx-auto mb-2" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "text-ink/50", children: "Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u" })
      ] }) }) }) : data.map((item, rowIndex) => {
        const key = typeof rowKey === "function" ? rowKey(item) : item[rowKey];
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("tr", { className: "hover:bg-ink-100 px-md py-sm", children: [
          select && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("td", { className: "border-b px-md py-md ", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            "input",
            {
              type: "checkbox",
          ...
          columns.map((col, index) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            "td",
            {
              ...
              children: col.render ? col.render(
                ...
                item,
                rowIndex
              ) : col.dataIndex ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "px-md py-sm", children: item[col.dataIndex] }) : null
            },
            index
          ))
        ] }, rowIndex);
    ...
    loading && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "absolute inset-0 flex items-center justify-center bg-ink-100/50", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(LoadingSpinner, {}) }),
    select && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-col gap-sm", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
        "div",
        {
          ...
          children: select.actions?.map((action, index) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            "div",
            {
