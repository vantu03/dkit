...
function Tabs({
  ...
  const [currentKey, setCurrentKey] = useState2(
...
function AppTable({
  ...
  const [sorter, setSorter] = useState3();
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "w-full bg-ink-0 relative flex flex-col gap-md", children: [
    /* @__PURE__ */ jsx13("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsxs9("table", { className: "min-w-full border-collapse", children: [
      ...
      /* @__PURE__ */ jsx13("tbody", { className: "", children: data.length === 0 ? /* @__PURE__ */ jsx13("tr", { children: /* @__PURE__ */ jsx13("td", { colSpan: columns.length, className: "p-md text-center h-36", children: !loading && /* @__PURE__ */ jsxs9(Fragment, { children: [
